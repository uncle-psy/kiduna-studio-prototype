...
const phases = [
  ...
  },
  {
    ...
    copy: "Turned the screens into a continuous Studio Field. Identity is chosen before entry and stays fixed inside the session. The Field remains underneath the HUD; focused conversations and artifacts rise to 94% opacity.",
  ...
  },
  {
    ...
    artifacts: ["Ki Stance v1.0", "Ki Wisdom corpus v2.5", "14 Ki Skills", "Conversation-driven Field states"],
  },
];
...
const architecture = [
  ...
  ["Skills", "14 Markdown skill packages", "Procedures for Field, identity, organizations, relationships, Projects, Actions, Wisdom, Actors, and compute"],
...
export default function PrototypeRecordPage() {
  return <main className={styles.record}>
    ...
    <header className={styles.masthead}>
      ...
      <div><span>PRIVATE WORKING RECORD</span><time>15 July 2026</time></div>
    </header>
    ...
    <section className={styles.hero}>
      ...
      <div><b>5</b><span>prototype phases</span><b>49</b><span>Ki source files</span><b>14</b><span>installed Skills</span><b>1</b><span>continuous Field</span></div>
    </section>

    <section className={styles.principles}>
      <span>WHAT CONTROLS THE WORK</span>
      <div>
        <article><b>01</b><h2>The Field is always present.</h2><p>Clear, Context, and Focus change the HUD’s weight—not whether the world exists.</p></article>
    ...
    <section className={styles.inventory}>
      ...
      <div>
        ...
        <article><span>SKILLS</span><h3>Fourteen installed procedures</h3><p>Prototype runtime, Field rendering, protection, Ally identity, relationships, Organizations, Projects, Actions, Forums, Wisdom, connections, Actors, capabilities, and compute.</p><small>content/ki/skills · 14 packages</small></article>
      </div>
    </section>
    ...
    <footer className={styles.footer}><Image src="/kiduna-mark.svg" width={32} height={32} alt="" /><p>This page is intentionally not linked from the demonstration. It is a working record, not a public product page.</p><span>studio prototype · 2026-07-15</span></footer>
  </main>;
}
