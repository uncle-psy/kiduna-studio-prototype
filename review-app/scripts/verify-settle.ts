 ...
 * verify-settle.ts
 *
 * Verifies that settle_launch created all expected on-chain artifacts.
 *
 * Usage:
...
const LAUNCHPAD = new PublicKey("moonDJUoHteKkGATejA5bdJVwJ6V6Dg74gyqyJTx73n");
 ...
 */
function parseLaunch(data: Buffer) {
...
async function main() {
  ...
  console.log(`\n🔍 Verifying settle_launch for: ${launchPda.toBase58()}`);
  console.log(`   RPC: ${RPC}\n`);
