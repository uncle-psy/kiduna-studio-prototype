...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_tenants_template" AS ENUM('website', 'portfolio', 'blog', 'landing');
  CREATE TYPE "public"."enum_tenants_status" AS ENUM('provisioning', 'active', 'suspended');
  CREATE TYPE "public"."enum_cms_users_roles" AS ENUM('super-admin', 'site-manager');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_pages_blocks_call_to_action_links_link_type" AS ENUM('primary', 'secondary');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'lowImpact', 'mediumImpact', 'highImpact');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_blocks_call_to_action_links_link_type" AS ENUM('primary', 'secondary');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'lowImpact', 'mediumImpact', 'highImpact');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_footer_socials_platform" AS ENUM('twitter', 'github', 'linkedin', 'instagram', 'youtube');
  CREATE TYPE "public"."enum_settings_typography_base_font_size" AS ENUM('14', '16', '18');
  CREATE TABLE "tenants" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"slug" varchar NOT NULL,
  	"owner_wallet" varchar NOT NULL,
  	"template" "enum_tenants_template" DEFAULT 'website' NOT NULL,
  	"status" "enum_tenants_status" DEFAULT 'provisioning' NOT NULL,
  	"mcp_api_key" varchar,
  	"global_tool_account_id" varchar,
  	"site_url" varchar,
  ...
  CREATE TABLE "pages_blocks_call_to_action_links" (
  	...
  	"link_label" varchar,
  	"link_url" varchar,
  	"link_type" "enum_pages_blocks_call_to_action_links_link_type" DEFAULT 'primary'
  );
  ...
  CREATE TABLE "_pages_v_blocks_call_to_action_links" (
  	...
  	"link_label" varchar,
  	"link_url" varchar,
  	"link_type" "enum__pages_v_blocks_call_to_action_links_link_type" DEFAULT 'primary',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"settings_update" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"enable_a_p_i_key" boolean,
  	"api_key" varchar,
  ...
  CREATE TABLE "settings" (
  	...
  	"logo_id" integer,
  	"favicon_id" integer,
  	"typography_body_font" varchar DEFAULT 'Inter',
  	"typography_heading_font" varchar DEFAULT 'Inter',
  	"typography_base_font_size" "enum_settings_typography_base_font_size" DEFAULT '16',
  	"colors_primary" varchar DEFAULT '#111111',
  	"colors_background" varchar DEFAULT '#ffffff',
  	"colors_text" varchar DEFAULT '#111111',
  ...
  ALTER TABLE "cms_users_tenants" ADD CONSTRAINT "cms_users_tenants_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_tenants_template";
  ...
  DROP TYPE "public"."enum_settings_typography_base_font_size";`)
}
